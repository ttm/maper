...
Este site é dedicado à publicação de mapas. Sua colaboração é muito bem vinda e pode ocorrer através de:
<ul>
    <li> criação de novos mapas </li>
    <li> complementos em mapas de terceiros </li>
    <li> idealização de usos do Mapas de Vista </li>
    <li> divulgação desta ferramenta </li>
    <li> escrita de código do Mapas de Vista </li>
    <li> aproximando-se da comunidade em torno do Mapas de Vista </li>
</ul>
